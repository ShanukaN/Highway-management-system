...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2021 at 06:20 PM
...
(13, 'PH-2', 'Vicks Vaporub', 'Balm', 'Helps in clearing your nasal package and removes clogging of nose. Temporarily provides relief to chest and throat.', '240', './image/ac73eddd95f310c89b2fb1c96f2b52b4vicks.jpg', 70, 20, 'Iodex'),
(14, 'PH-3', 'Jovees Papaya And Honey Mud Scrub', 'Cream', 'A unique formulation that helps to discover a new kind of luminosity day after day.', '890', './image/f24b70dd1c873719775e2f906f5bb9ebjavees.jpg', 50, 20, 'Javees'),
(15, 'PH-4', 'Baby Cheramy Baby Regular Talc', 'Cream', 'Reduce the extra moisture on your skin. Keeps baby dry & happy.', '120', './image/7d7664ff0600b6e924a1ccea548dbb63babay cream.jpg', 60, 20, 'Baby Cheramy'),
...
(11, '5', 'Nirmal', 'Perera', 'shanukaict4.2019@gmail.com', '0716524811', 'No,17/A,Mirigama', 1300, 'pending', '2021-11-17'),
(15, '4', 'Sadun', 'Perera', 'shanuka.nadeeshan2014@gmail.com', '0714525411', '10/A , Gampaha', 150, 'done', '2021-11-17'),
(16, '4', 'Sadun', 'Perera', 'shanuka.nadeeshan2014@gmail.com', '0714525411', '10/A , Gampaha', 150, 'done', '2021-11-17'),
(17, '4', 'Sadun', 'Perera', 'shanuka.nadeeshan2014@gmail.com', '0714525411', '10/A , Gampaha', 140, 'pending', '2021-11-17');
...
(10, 11, 'Vicks Vaporub', 1, 240),
(11, 11, 'Clogard Toothpaste', 1, 50),
(12, 11, 'Jovees Papaya And Honey Mud Scrub', 1, 890),
(13, 11, 'Baby Cheramy Baby Regular Talc', 1, 120),
(20, 15, 'Metformin', 1, 50),
(21, 15, 'Betadine', 1, 100),
(22, 16, 'Betadine', 1, 100),
(23, 16, 'Metformin', 1, 50),
(24, 17, 'cetirizine', 2, 40),
(25, 17, 'Betadine', 1, 100);
...
(55, '4', 'Sadun', '10/A , Gampaha', '../Admin/priscription/ph.jpg', 'shanuka.nadeeshan2014@gmail.com', 'pending', '2021-11-17', ''),
(56, '4', 'Sadun', '10/A , Gampaha', '../Admin/priscription/boy.jpg', 'shanuka.nadeeshan2014@gmail.com', 'pending', '2021-11-17', ''),
(57, '4', 'Sadun', '10/A , Gampaha', '../Admin/priscription/a.png', 'shanuka.nadeeshan2014@gmail.com', 'pending', '2021-11-17', '');
...
(49, 'SUP-4', 'Kanishka', '80/A,Colomo5', '0717535244', 'MD');
...
--
ALTER TABLE `order`
  MODIFY `order_no` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `order_details`
  ADD CONSTRAINT `order_details_ibfk_1` FOREIGN KEY (`order_no`) REFERENCES `order` (`order_no`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
